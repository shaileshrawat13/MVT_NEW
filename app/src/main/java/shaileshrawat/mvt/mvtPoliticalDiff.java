 ...
 */
public class mvtPoliticalDiff extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerAdapter.add(modiPolitcalComparison.class, new Bundle());
        pagerAdapter.add(trumpPolitcalComparison.class, blue);
